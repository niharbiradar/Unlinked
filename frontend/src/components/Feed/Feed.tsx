  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-200 mb-2">Error loading posts</h3>
      ...
      <div className="space-y-6">
        {[...Array(3)].map((_, index) => (
          <div key={index} className="card animate-pulse">
            ...
            <div className="h-4 bg-dark-600 rounded mb-2 w-3/4"></div>
            <div className="h-4 bg-dark-600 rounded mb-4 w-1/2"></div>
